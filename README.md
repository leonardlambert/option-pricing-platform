...
- **Option pricing & Greeks**
  ...
  ![alt text](https://github.com/leonardlambert/market-risk-pricing-platform/images/tab1.png 'Single Option Pricing & Greeks by finite differences')
...
- **Strategy builder and Spread visualization**
  ...
  ![alt text](https://github.com/leonardlambert/market-risk-pricing-platform/images/tab2.png 'Spread building and visualization')
...
- **Volatility smile**
  ...
  ![alt text](https://github.com/leonardlambert/market-risk-pricing-platform/images/tab4.png 'Volatility smile construction using dataset or live API data')
